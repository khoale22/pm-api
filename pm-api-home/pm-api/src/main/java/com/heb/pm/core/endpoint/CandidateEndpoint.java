...
import com.heb.pm.core.service.CandidateService;
...
public class CandidateEndpoint {
	...
	public Candidate validate(
			...
			@ApiParam("The named validators. Valid values are: VENDOR_DATA_VALIDATOR, BUYER_DATA_VALIDATOR, SCA_DATA_VALIDATOR")
		...
		CandidateEndpoint.logger.info(String.format(CandidateEndpoint.VALIDATE_LOG_MESSAGE, user, listOfValidators.toString(), candidate.getCandidateId()));

		this.candidateService.validate(validatorTypes, candidate);
		return candidate;
	}
}
