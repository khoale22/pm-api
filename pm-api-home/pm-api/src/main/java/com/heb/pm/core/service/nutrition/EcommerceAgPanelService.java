...
/**
 * Handles eCommerce nutrition panels that follow the Department of Agriculture (NLEA 2019) standard.
 *
 * @author d116773
 * @since 1.4.0
 */
@Service
/* default */ class EcommerceAgPanelService extends BaseEcommercePanelService {

	/**
	 * Constructs a new EcommerceAgPanelService.
	 */
	public EcommerceAgPanelService() {
		super();
	...
	protected boolean handlesPanel(ProductPackVariation productPackVariation) {
		return !BaseEcommercePanelService.ecommercePanelIs2016(productPackVariation) &&
				!BaseEcommercePanelService.ecommercePanelIsSuppliment(productPackVariation);
	}
}
